...
<!--头部-->
    <div class="wrapper router">
        ...
        <div class="sch-result">
            <span class="tag">洋酒</span><span class="fl">共<span class="num">218</span>个产品</span>
        </div>
    </div>
        ...
        <div class="wrapper">
            <div class="sch-prop sch-brand">
                ...
                <div class="sch-value clearfix">
                    <div class="item">
                        <a class="inner" href="">
                            <img src="uploads\24.png" alt="">
                            <div class="name">白兰地</div>
                        </a>
                    </div>
                    <div class="item">
                        <a class="inner" href="">
                            <img src="uploads\25.png" alt="">
                            <div class="name">嘉和啤酒</div>
                        </a>
                    </div>
                    <div class="item">
                        <a class="inner" href="">
                            <img src="uploads\26.png" alt="">
                            <div class="name">那年九方</div>
                        </a>
                    </div>
                    <div class="item">
                        <a class="inner" href="">
            ...
            <div class="sch-prop clearfix">
                ...
                <div class="sch-value clearfix">
                    <a href="">酒不错</a><a href="">送货快</a><a href="">包装好</a><a href="">价格便宜</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sg-main wrapper">
        <div class="sg-content">
            ...
            <div class="sg-list clearfix">
                <div class="col col-3">
                    <div class="item">
                        <div class="inner">
                            <a href="goods-detail.jsp"><img class="figure" src="uploads\34.png" alt=""></a>
                            <a href="goods-detail.jsp"><div class="name">私人红酒屋</div><div class="price">699元</div></a>
        ...
        <div class="sg-aside">
            ...
            <div class="shop-hot">
                <div class="item">
                    <a href=""><img class="figure" src="uploads\33.png" alt=""></a>
                    <div class="p-name"><a href="">英国 威士忌</a></div>
 ...
 <!--脚部-->
    ...
    <div class="footer">贵州茅台酒股份有限公司 版权所有 Copyright © 2016-2018   备案号：皖ICP备123456789</div>
    <!--脚部-->
